...
import boto3
import json
from aws.config import json_extraction_bucket, region,json_appender_lambda


ZIP_FILE_NAME = 'json_appender.zip'
...
def create_lambda_function3():
    ...
    try:
        ...
        response = lambda_client.create_function(
            FunctionName=json_appender_lambda,
            Runtime=RUNTIME,
        ...
        print(f"ℹ️ Lambda function '{json_appender_lambda}' already exists.")
    ...
    try:
        ...
        try:
            lambda_client.add_permission(
                ...
                SourceArn=f'arn:aws:s3:::{json_extraction_bucket}',
        ...
        s3_client.put_bucket_notification_configuration(
            Bucket=json_extraction_bucket,
            NotificationConfiguration={
                'LambdaFunctionConfigurations': [
                    {
                        'LambdaFunctionArn': f'arn:aws:lambda:{region}:83192cxxx080(change):function:{json_appender_lambda}',
